...
const QUOTA_COPY: Record<SiteQuotaState, { className: string; label: string }> =
	{
		...
		healthy: {
			className: "border-success/35 bg-success/10 text-status-success",
			label: "On track",
		},
	};
...
function StatusPill({
	...
	const toneClassName = {
		danger: "border-destructive/35 bg-destructive/10 text-status-destructive",
		info: "border-info/35 bg-info/10 text-status-info",
		neutral: "border-border bg-muted/55 text-muted-foreground",
		success: "border-success/35 bg-success/10 text-status-success",
