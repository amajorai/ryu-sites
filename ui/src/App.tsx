	...
	return (
		<div className="flex flex-wrap items-end justify-between gap-3">
			<div>
				...
				<h2 className="mt-1 font-semibold text-xl tracking-tight">{title}</h2>
			</div>
		...
		<div className="rounded-2xl border border-border/70 bg-card p-4 shadow-sm">
			...
			<div className="mt-4 grid grid-cols-2 gap-3 text-xs">
				<div className="rounded-xl bg-muted/55 p-3">
					...
					<p className="mt-1 font-semibold text-lg">{connector.routeCount}</p>
				</div>
				<div className="rounded-xl bg-muted/55 p-3">
...
function HeroCard({ project }: { project: SiteProject }) {
	return (
		<section className="sites-hero relative overflow-hidden rounded-[28px] border border-slate-800/70 bg-slate-950 p-6 text-white shadow-slate-950/10 shadow-xl sm:p-8">
			<div className="relative z-10 max-w-xl">
				<div className="flex flex-wrap items-center gap-2">
					<p className="font-mono text-[10px] text-sky-200/70 uppercase tracking-[0.18em]">
						Primary site · demo project
					</p>
					<StatusPill label="Published preview" tone="info" />
				</div>
				<h1 className="mt-4 font-semibold text-3xl tracking-[-0.04em] sm:text-4xl">
					{project.name}
				</h1>
				<p className="mt-3 max-w-lg text-slate-300 text-sm leading-relaxed">
					A single project identity can point at a local preview, an
					operator-owned relay, or the managed Ryu edge without changing the
					deployment record.
				</p>
				<div className="mt-6 flex flex-wrap items-center gap-2">
					<span className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/10 px-3 py-2 font-mono text-sky-100 text-xs">
						<HugeiconsIcon aria-hidden="true" icon={Link01Icon} />
						{managedSiteOrigin(project.slug)}
					</span>
					<span className="rounded-xl border border-sky-300/20 bg-sky-300/10 px-3 py-2 font-mono text-[10px] text-sky-100 uppercase tracking-[0.12em]">
						Wildcard managed URL
					</span>
				</div>
			</div>
			<div className="pointer-events-none absolute -right-14 -bottom-28 size-72 rounded-full border border-sky-300/20 bg-sky-300/10 blur-[1px]" />
			<div className="pointer-events-none absolute top-0 right-0 h-full w-2/5 bg-[radial-gradient(circle_at_70%_25%,rgba(56,189,248,0.25),transparent_58%)]" />
		</section>
	);
}
			...
			<div className="flex flex-wrap items-end justify-between gap-4">
				<div>
					<p className="font-mono text-[10px] text-muted-foreground uppercase tracking-[0.18em]">
						Sites control surface
					</p>
					<h1 className="mt-2 font-semibold text-3xl tracking-[-0.04em]">
						Publish with a clear edge story.
					</h1>
					<p className="mt-2 max-w-2xl text-muted-foreground text-sm leading-relaxed">
						Preview the route, the connector, the domain, and the quota before a
			...
			<section className="rounded-[28px] border border-border/70 bg-card p-5 shadow-sm sm:p-7">
				<div className="flex flex-wrap items-start justify-between gap-4 border-border/70 border-b pb-6">
					<div className="flex items-start gap-4">
						<span className="flex size-12 items-center justify-center rounded-2xl bg-primary/10 font-semibold text-primary">
							N
						</span>
						<div>
							<div className="flex flex-wrap items-center gap-2">
				...
				<div className="mt-6 grid gap-4 md:grid-cols-3">
					...
					<div className="rounded-2xl bg-muted/45 p-4">
						...
						<p className="mt-2 font-semibold text-sm">Version 7 · ready</p>
						<p className="mt-2 text-muted-foreground text-xs">
					...
					<div className="rounded-2xl bg-muted/45 p-4">
						...
						<p className="mt-2 font-semibold text-sm">Local project</p>
						<p className="mt-2 text-muted-foreground text-xs">
					...
					<div className="mx-auto max-w-[420px] overflow-hidden rounded-[24px] border border-white/10 bg-white text-slate-950 shadow-2xl">
						<div className="flex items-center justify-between border-slate-200 border-b px-5 py-4">
							<div className="flex items-center gap-2">
								<span className="flex size-8 items-center justify-center rounded-xl bg-sky-500 font-semibold text-white text-xs">
									R
								</span>
								<div>
									<p className="font-semibold text-sm">Northstar Help</p>
